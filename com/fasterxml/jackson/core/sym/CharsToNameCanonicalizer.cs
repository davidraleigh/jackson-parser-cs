...
namespace com.fasterxml.jackson.core.sym
{
	...
	/// </remarks>
	public sealed class CharsToNameCanonicalizer
	{
		public const int HASH_MULT = 33;

		/// <summary>Default initial table size.</summary>
		/// <remarks>
		...
		/// </remarks>
		protected internal const int DEFAULT_T_SIZE = 64;
		...
		/// </summary>
		protected internal const int MAX_T_SIZE = unchecked((int)(0x10000));
		...
		/// </remarks>
		internal const int MAX_ENTRIES_FOR_REUSE = 12000;
		...
		/// </remarks>
		/// <since>2.1</since>
		internal const int MAX_COLL_CHAIN_LENGTH = 100;

		internal static readonly com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer 
			sBootstrapSymbolTable = new com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer
			();
		...
		/// </remarks>
		protected internal com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer _parent;
		...
		protected internal readonly int _flags;

		/// <summary>
		/// Whether any canonicalization should be attempted (whether using
		/// intern or not)
		/// </summary>
		protected internal bool _canonicalize;

		/// <summary>
		/// Primary matching symbols; it's expected most match occur from
		/// here.
		/// </summary>
		protected internal string[] _symbols;
		...
		/// </remarks>
		protected internal com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket
			[] _buckets;
		...
		/// </remarks>
		protected internal int _sizeThreshold;
		...
		/// a power of two.
		/// </summary>
		protected internal int _indexMask;
		...
		*/
		...
		protected internal static com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer
			 createRoot(int hashSeed)
		{
			return sBootstrapSymbolTable.makeOrphan(hashSeed);
		}

		/// <summary>Main method for constructing a master symbol table instance.</summary>
		...
		private void initTables(int initialSize)
		{
			...
			_buckets = new com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket[initialSize
				 >> 1];
		...
		/// <summary>Internal constructor used when creating child instances.</summary>
		private CharsToNameCanonicalizer(com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer
			 parent, int flags, string[] symbols, com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket
			[] buckets, int size, int hashSeed, int longestColl)
		{
			_parent = parent;
			_flags = flags;
			_canonicalize = com.fasterxml.jackson.core.JsonFactory.Feature.CANONICALIZE_FIELD_NAMES
				.enabledIn(flags);
			_symbols = symbols;
			_buckets = buckets;
			_size = size;
		...
		/// </remarks>
		public com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer makeChild(int flags
			)
		{
			...
			*/
			...
			return new com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer(this, flags, symbols
				, buckets, size, hashSeed, longestCollisionList);
		}

		private com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer makeOrphan(int seed
			)
		{
			return new com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer(null, -1, _symbols
				, _buckets, _size, seed, _longestCollisionList);
		}
		...
		/// </remarks>
		private void mergeChild(com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer child
			)
		{
			...
			*/
			if (child.size() > MAX_ENTRIES_FOR_REUSE)
			{
				...
				lock (this)
				{
					initTables(DEFAULT_T_SIZE * 4);
					// no point in starting from tiny tho
		...
		*/
		...
		{
			int count = 0;
			foreach (com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket bucket in 
				_buckets)
			{
				if (bucket != null)
				{
		...
		*/
		public string findSymbol(char[] buffer, int start, int len, int h)
		{
			...
			*/
			...
			if (sym != null)
			{
				...
				com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket b = _buckets[index
					 >> 1];
				if (b != null)
				{
		...
		private string _findSymbol2(char[] buffer, int start, int len, com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket
			 b)
		{
			while (b != null)
			{
		...
		private string _addSymbol(char[] buffer, int start, int len, int h, int index)
		{
			...
			{
				newSymbol = com.fasterxml.jackson.core.util.InternCache.instance.intern(newSymbol
					);
			}
			++_size;
			...
			{
				int bix = (index >> 1);
				com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket newB = new com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket
					(newSymbol, _buckets[bix]);
				...
				{
					_buckets[bix] = newB;
					_longestCollisionList = System.Math.max(collLen, _longestCollisionList);
				}
			}
			return newSymbol;
		}
		...
		public int _hashToIndex(int rawHash)
		{
			...
			rawHash += ((int)(((uint)rawHash) >> 15));
			rawHash ^= (rawHash << 7);
			rawHash += ((int)(((uint)rawHash) >> 3));
		...
		*/
		...
		private void copyArrays()
		{
			...
			_symbols = java.util.Arrays.copyOf(oldSyms, oldSyms.Length);
			com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket[] oldBuckets = _buckets;
			_buckets = java.util.Arrays.copyOf(oldBuckets, oldBuckets.Length);
		}
		...
		private void rehash()
		{
			...
			*/
			if (newSize > MAX_T_SIZE)
			{
				...
				*/
				...
				_buckets = new com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket[DEFAULT_T_SIZE
					 >> 1];
			...
			_buckets = new com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket[newSize
				 >> 1];
			...
			*/
			...
			{
				com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket b = oldBuckets[i_1
					];
				while (b != null)
				{
					++count;
			...
			if (count != _size)
			{
				throw new Sharpen.Error("Internal error on SymbolTable.rehash(): had " + _size + 
					" entries; now have " + count + ".");
			}
		}
		...
		protected internal void reportTooManyCollisions(int maxLen)
		{
			throw new System.InvalidOperationException("Longest collision chain in symbol table (of size "
				 + _size + ") now exceeds maximum, " + maxLen + " -- suspect a DoS attack based on hash collisions"
				);
		}

		/// <summary>This class is a symbol table entry.</summary>
		/// <remarks>
		...
		internal sealed class Bucket
		{
			...
			public readonly com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket next;

			public readonly int length;

			public Bucket(string s, com.fasterxml.jackson.core.sym.CharsToNameCanonicalizer.Bucket
				 n)
			{
